...
public class RandomDeviceProfile extends RandomElement {
    private static final String[] SETTINGS = new String[] {
            ...
            RandomizersCache.SETTING_ANDROID_BUILD_DATE_EPOC,
            RandomizersCache.SETTING_ANDROID_BUILD_DATE,
            RandomizersCache.SETTING_ANDROID_BUILD_DATE_ONE,
            RandomizersCache.SETTING_ANDROID_BUILD_DATE_TWO,
            ...
            RandomizersCache.SETTING_ANDROID_BUILD_PATCH,
            RandomizersCache.SETTING_ANDROID_ETC_BUILD_ROM_VERSION_CODENAME,
            RandomizersCache.SETTING_ANDROID_ETC_BUILD_ROM_VARIANT,
            RandomizersCache.SETTING_ANDROID_KERNEL_SYS_NAME,
            RandomizersCache.SETTING_ANDROID_KERNEL_NODE_NAME,
            RandomizersCache.SETTING_ANDROID_KERNEL_RELEASE,
            RandomizersCache.SETTING_ANDROID_KERNEL_VERSION,
